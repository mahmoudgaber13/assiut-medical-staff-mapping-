...
$i=1;
$q=mysql_query("delete from sur_pharmacy",$db)or die(mysql_error());
while($i<=51)
{
	
	$q=mysql_query("select lat,lang from pharmacy where id= $i",$db)or die(mysql_error());
	...
	$qq=mysql_query("Insert into sur_pharmacy values($i , $dist)",$db)or die(mysql_error());
...
<head>
	...
	<style type="text/css">
			...
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCoNb2pr6QCJegnk6JbowePMYZ1Zvj_rxo"type="text/javascript"></script>
			 ...
			 $q=mysql_query("select * from sur_pharmacy,pharmacy where sur_pharmacy.id=pharmacy.id order by dist limit 5",$db);
			 mysql_query("SET NAMES 'utf8'");
			 ...
			 $desc=$row['address'];
			 $phone=$row['phone'];
			 echo ("addMarker($lat, $lon,'<b>الاسم:$name</b><br/>العنوان:$desc<br/>0الهاتف:$phone');\n");
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
					...
					<li>
						<a class="page-scroll" href="#download">بيانات الصيدليات</a>
					</li>
					<li >
						<a  class="page-scroll" href="#about">أقرب صيدليات</a>
					</li>
					<li >			
