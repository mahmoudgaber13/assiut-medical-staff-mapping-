...
$i=1;
$q=mysql_query("delete from sur_doctors",$db)or die(mysql_error());
while($i<=151)
{
	
	$q=mysql_query("select lat,lang from doctors where id= $i",$db)or die(mysql_error());
	...
	$qq=mysql_query("Insert into sur_doctors values($i , $dist)",$db)or die(mysql_error());
...
<head>
	...
	<style type="text/css">
			...
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCoNb2pr6QCJegnk6JbowePMYZ1Zvj_rxo"type="text/javascript"></script>
			 ...
			 $q=mysql_query("select * from sur_doctors,doctors where sur_doctors.id=doctors.id order by dist limit 5",$db);
			 mysql_query("SET NAMES 'utf8'");
			 ...
			 $desc=$row['clinic'];
			 $phone=$row['phone'];
			 echo ("addMarker($lat, $lon,'<b>الاسم:$name</b><br/>العنوان:$desc<br/>الهاتف:$phone');\n");
			
			 echo ("addMarker($xxx, $yyy,'<b>انا هنا</b>');\n");
			}			
...
<body onLoad="initMap()" id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" >
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
					...
					<li>
						<a class="page-scroll" href="#download">بيانات الاطباء</a>
					</li>
					<li >
						<a  class="page-scroll" href="#about">أقرب أطباء</a>
					</li>
    ...
    <section id="download" class="content-section text-center">
		...
		<tr align="center" >
			...
			<th style="text-align:center">العنوان
			</th>
			<th style="text-align:center">الدرجه العلميه
			</th>
			<th style="text-align:center">التخصص
			</th>
