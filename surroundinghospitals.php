...
$i=1;
$q=mysql_query("delete from sur_hospitals",$db)or die(mysql_error());
while($i<=20)
{
	
	$q=mysql_query("select h_lat,h_lang from hospitals where h_id= $i",$db)or die(mysql_error());
	...
	$qq=mysql_query("Insert into sur_hospitals values($i , $dist)",$db)or die(mysql_error());
...
<head>
	...
	<style type="text/css">
			...
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCoNb2pr6QCJegnk6JbowePMYZ1Zvj_rxo"type="text/javascript"></script>
			 ...
			 $q=mysql_query("select * from sur_hospitals,hospitals where sur_hospitals.id=hospitals.h_id order by dist limit 5",$db);
			 mysql_query("SET NAMES 'utf8'");
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
					...
					<li>
						<a class="page-scroll" href="#download">بيانات المستشفيات</a>
					</li>
					<li >
						<a  class="page-scroll" href="#about">أقرب مستشفيات</a>
					</li>
