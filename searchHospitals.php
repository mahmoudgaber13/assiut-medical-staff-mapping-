    ...
    <title>المستشفيات</title>
			...
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCoNb2pr6QCJegnk6JbowePMYZ1Zvj_rxo"type="text/javascript"></script>
			 ...
			 style: google.maps.NavigationControlStyle.SMALL
			  ...
			  <?php
			 $hospitalName=$_POST['searchByHospitalsName'];
			 $q=mysql_query("select * from hospitals where h_name like '%$hospitalName%'",$db);
			 mysql_query("SET NAMES 'utf8'");
			 ...
			 echo ("addMarker($lat, $lon,'<b>الاسم:$name</b><br/>العنوان:$desc</b><br/>الهاتف:$phone');\n");
			 }
...
<body  onLoad="initMap()" id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a class="page-scroll" href="#hospitals"><h5>المستشفيات</h5></a>
                    </li>
    ...
    <section id="hospitals" class="content-section text-center">
		...
		<tr align="center">
			<th style="text-align:center">التليفون
			</th>
