...
<head>
    ...
    <title>الصيدليات</title>
		...
		mysql_query("SET NAMES 'utf8'");
		$pharmacyAddress=$_POST['pharmacyStreet'];
		if (isset($pharmacyAddress))
		{
			$q=mysql_query("select * from pharmacy where address like '%$pharmacyAddress%'",$db);	
		}
			 mysql_query("SET NAMES 'utf8'");
...
<body  onLoad="initMap()" id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <section id="pharmacy" class="content-section text-center">
		...
		<tr align="center">
			...
			<th style="text-align:center">اسم الصيدليه
			</th>
		</tr>
		<?php
